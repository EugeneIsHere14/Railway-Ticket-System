...
public class LogoutMainPageCommand extends Command {

    private static final long serialVersionUID = 4348751270963471272L;

    private static final Logger LOGGER = Logger.getLogger(LogoutMainPageCommand.class);
